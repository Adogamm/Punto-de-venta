...
INSERT INTO VEHICULOS (MARCA,MODELO,COLOR,PLACAS,ID_CLIENTE) VALUES
('CHEVROLET','CRUIZE','ROJO','AAAAAAAAA',1),
('CHEVROLET','AVEO','PLATA','BBBBBBBBB',2),
('NISSAN','ESTAQUITAS','BLANCA','CCCCCCCCC',3),
('VOLKSWAGEN','POINTER','ROJO','DDDDDDDDD',4);
...
SELECT c.NOMBRE,c.TELEFONO, CONCAT(v.MARCA," ", v.MODELO) as COCHE, v.PLACAS,
...
-- CONSULTA PARA EL CATALOGO DE VEHICULOS
SELECT v.*,c.NOMBRE FROM VEHICULOS AS v
